...
class EditDiscountFood extends StatefulWidget {
  @override
  State<EditDiscountFood> createState() => _EditDiscountFoodState();
}

class _EditDiscountFoodState extends State<EditDiscountFood> {
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot?> snapshot) {
            return snapshot.data == null
                ...
                : snapshot.data!.docs.length == 0
                    ? Center(
                        child: Text("Not yet have Discount Food"),
                      )
                    : ListView.builder(
                        shrinkWrap: true,
