...
class ShowOrder extends StatefulWidget {
  ...
  String totalAmt;
  String phone;
  ShowOrder(this.id, this.totalAmt, this.phone, this.description);
  @override
...
class _ShowOrderState extends State<ShowOrder> {
  ...
  void selectConfirmType(context) {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text(
              "Call the customer to confiem the order",
              style: TextStyle(
            ...
            content: Text(
              "You need to call customer to confirm order",
              style: TextStyle(
                color: Theme.of(context).primaryColor,
              ),
            ),
              ...
              TextButton.icon(
                onPressed: () {
                  ...
                  Navigator.of(context)
                    ...
                    return SendSMS(phone: widget.phone, id: widget.id);
                  }));
                },
